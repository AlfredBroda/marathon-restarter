APPLICATION_NAME    := github.com/allegro/marathon-restarter
...
build: $(BUILD_FOLDER)/marathon-restarter

$(BUILD_FOLDER)/marathon-restarter: $(GO_SRC)
	$(GO_BUILD) -o $(BUILD_FOLDER)/marathon-restarter
...
package: build
	zip -j $(BUILD_FOLDER)/marathon-restarter-linux-amd64.zip $(BUILD_FOLDER)/marathon-restarter
	chmod 0755 $(BUILD_FOLDER)/marathon-restarter-linux-amd64.zip
